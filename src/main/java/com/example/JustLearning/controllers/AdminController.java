...
public class AdminController {
    ...
    public AdminController(UserRepository userRepository, SightsRepository sightsRepository, SightsService sightsService, @Value("${json.path}") String jsonPath, UserService userService) {
